...
--
-- Host: localhost    Database: mDepart
-- ------------------------------------------------------
...
CREATE TABLE `locations` (
  ...
  `is_transportation_stop` tinyint(1) DEFAULT NULL,
  `position_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `address_id` (`address_id`),
  KEY `position_id` (`position_id`),
  CONSTRAINT `locations_ibfk_1` FOREIGN KEY (`address_id`) REFERENCES `addresses` (`id`),
  CONSTRAINT `locations_ibfk_2` FOREIGN KEY (`position_id`) REFERENCES `positions` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `locations` VALUES (0,'home',NULL,0,0);
...
INSERT INTO `positions` VALUES (0,'45.4963857','-73.62036');
...
-- Dump completed on 2014-05-18 11:15:17
